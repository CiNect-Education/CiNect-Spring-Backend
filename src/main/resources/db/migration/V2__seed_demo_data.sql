...
VALUES
  ...
  (
    ...
    'lat-mat-8-hoi-ket',
    'The final chapter of the blockbuster Face Off series. Long-buried secrets are revealed in the ultimate clash between good and evil, where the line between right and wrong becomes increasingly blurred.',
    ...
    NULL,
    135, '2026-02-01', 'Lý Hải',
    '["Lý Hải", "Trường Giang", "Ốc Thanh Vân", "Huy Khánh"]'::jsonb,
  ...
  (
    ...
    'Mai 2',
    'mai-2',
    'The sequel to the hit film Mai. This emotional love story continues with new twists as Mai confronts her past and rediscovers herself.',
    ...
    NULL,
    125, '2026-04-10', 'Trấn Thành',
    '["Phương Anh Đào", "Tuấn Trần", "NSƯT Việt Hương", "Ngọc Giàu"]'::jsonb,
